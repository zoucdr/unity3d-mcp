...
namespace Microsoft.Unity.VisualStudio.Editor
{
	internal static class Discovery
	{
		...
		{
			foreach (var installation in VisualStudioTraeCNInstallation.GetVisualStudioInstallations())
		...
		public static bool TryDiscoverInstallation(string editorPath, out IVisualStudioInstallation installation)
		{
			try
			{
				if (VisualStudioTraeCNInstallation.TryDiscoverInstallation(editorPath, out installation))
					return true;
		...
		{
            VisualStudioTraeCNInstallation.Initialize();
